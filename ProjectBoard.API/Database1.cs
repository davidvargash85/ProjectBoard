...
//     Configuration file:     "ProjectBoard.API\Web.config"
//     Connection String Name: "local"
//     Connection String:      "Data Source=NENITA;Initial Catalog=ProjectBoard;Integrated Security=True"
// ------------------------------------------------------------------------------------------------
...
namespace ProjectBoard.API
{
    ...
    {
        System.Data.Entity.DbSet<Card> Cards { get; set; } // Card
    ...
    {
        public System.Data.Entity.DbSet<Card> Cards { get; set; } // Card
    ...
    public class Card
    {
        ...
        /// <summary>
        /// Parent Project pointed by [Card].([ProjectId]) (FK_Item_Project)
        /// </summary>
        public virtual Project Project { get; set; } // FK_Item_Project

        /// <summary>
        /// Parent Stage pointed by [Card].([StageId]) (FK_Item_Stage)
        /// </summary>
        public virtual Stage Stage { get; set; } // FK_Item_Stage
    }
    ...
    public class Project
    {
        ...
        /// <summary>
        /// Child Cards where [Card].[ProjectId] point to this entity (FK_Item_Project)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Card> Cards { get; set; } // Card.FK_Item_Project
        /// <summary>
        /// Child Stages where [Stage].[ProjectId] point to this entity (FK_Stage_Project)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Stage> Stages { get; set; } // Stage.FK_Stage_Project
    ...
    public class Stage
    {
        ...
        /// <summary>
        /// Child Cards where [Card].[StageId] point to this entity (FK_Item_Stage)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Card> Cards { get; set; } // Card.FK_Item_Stage
    ...
    public class CardConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Card>
    {
        ...
        public CardConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Project).WithMany(b => b.Cards).HasForeignKey(c => c.ProjectId).WillCascadeOnDelete(false); // FK_Item_Project
            HasRequired(a => a.Stage).WithMany(b => b.Cards).HasForeignKey(c => c.StageId).WillCascadeOnDelete(false); // FK_Item_Stage
        }
    }
    ...
    // Stage
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.36.1.0")]
    public class StageConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Stage>
    {
        ...
        public StageConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Project).WithMany(b => b.Stages).HasForeignKey(c => c.ProjectId).WillCascadeOnDelete(false); // FK_Stage_Project
        }
    }
