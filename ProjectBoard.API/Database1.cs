...
namespace ProjectBoard.API
{
    ...
    public class Item
    {
        ...
        /// <summary>
        /// Parent Project pointed by [Item].([ProjectId]) (FK_Item_Project)
        /// </summary>
        public virtual Project Project { get; set; } // FK_Item_Project

        /// <summary>
        /// Parent Stage pointed by [Item].([StageId]) (FK_Item_Stage)
        /// </summary>
    ...
    public class Project
    {
        ...
        /// <summary>
        /// Child Items where [Item].[ProjectId] point to this entity (FK_Item_Project)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Item> Items { get; set; } // Item.FK_Item_Project
        /// <summary>
    ...
    public class Stage
    {
        ...
        public System.DateTime DataCreated { get; set; } // DataCreated

        // Reverse navigation

        /// <summary>
        /// Child Items where [Item].[StageId] point to this entity (FK_Item_Stage)
        /// </summary>
        public virtual System.Collections.Generic.ICollection<Item> Items { get; set; } // Item.FK_Item_Stage
    ...
    public class ItemConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Item>
    {
        ...
        public ItemConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.Project).WithMany(b => b.Items).HasForeignKey(c => c.ProjectId).WillCascadeOnDelete(false); // FK_Item_Project
            HasRequired(a => a.Stage).WithMany(b => b.Items).HasForeignKey(c => c.StageId).WillCascadeOnDelete(false); // FK_Item_Stage
        }
    }
